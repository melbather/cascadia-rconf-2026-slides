...
## Hello :) {background-image="img/main_background.png"}
...
## R-Ladies Vancouver! {background-image="img/main_background.png"}
...
## The idea {background-image="img/main_background.png"}

![](img/bigfoot-app.png){fig-align="center"}


## Assumptions {background-image="img/main_background.png"}
...
# Definitions {background-image="img/main_background.png"}

## Spatial point process {background-image="img/main_background.png"}
...
## Poisson point processes {background-image="img/main_background.png" .smaller}
...
# Data Sources {background-image="img/main_background.png"}

## Option 1: {background-image="img/main_background.png" .smaller}
...
## Option 2: {background-image="img/main_background.png" .smaller}
...
## The BFRO Dataset {background-image="img/main_background.png"}
...
# Analysis! {background-image="img/main_background.png"}

## Cleaning data {background-image="img/main_background.png"}
...
## `spatstat` package {background-image="img/main_background.png"}
...
## Decide on our variables of interest {background-image="img/main_background.png"}
...
## Problem {background-image="img/main_background.png"}
...
## Create a study window {background-image="img/main_background.png"}
...
## Create a point pattern {background-image="img/main_background.png"}
...
# ✨Simulation magic✨ {background-image="img/main_background.png"}
*Unfortunately out of scope for this presentation, but you can see what I did in the GitHub repo*

## Inhomogeneous Poisson Point Model {background-image="img/main_background.png"}
...
## Interpreting the results {background-image="img/main_background.png" .smaller}
...
## Limitations of the inhomogeneous Poisson point process {background-image="img/main_background.png"}
...
## Further analysis {background-image="img/main_background.png"}
...
## References {background-image="img/main_background.png" .smaller}
